...
title=Label(win,text="Banking Automation",font=('arial',50,'italic','underline'),bg='pink')
title.pack()
...
def forgotpass_screen():
    ...
    def forgotpass_db():
        ...
        conobj=sqlite3.connect(database="bank.sqlite")
        curobj=conobj.cursor()
        curobj.execute("select acn_pass from acn where acn where acn_no=? and acn_email=? and acn_mob=?",(acn,email,mob,))
        tup=curobj.fetchone()
        if tup==None:
            messagebox.showerror("Forgot Pass","Record not found")
        else:
            messagebox.showeinfo("Forgot Pass",f"Your Pass={tup[0]}")
        conobj.close()
    
    btn_New=Button(frm,text="Back",font=('arial',20,'bold'),bd=5,command=back)
    btn_New.place(relx=0,rely=0)

    lbl_acn=Label(frm,text="Accn",font=('arial',20,'bold'),bg='powder blue')
    ...
    e_email=Entry(frm,font=('arial',20,'bold'),bd=1)
    ...
    btn_Submit.place(relx=.45,rely=.4)
...
def welcome_screen():
    ...
    def details():
        ...
        lbl_Wel=Label(ifrm,text="Your Details",font=('arial',20,'bold'),bg='white',fg='blue')
        lbl_Wel.pack()
    ...
    def update():
        ...
        lbl_Wel=Label(ifrm,text="Update Form",font=('arial',20,'bold'),bg='white',fg='blue')
        lbl_Wel.pack()
    ...
    def withdraw():
        ...
        lbl_wel=Label(ifrm,text="Withdraw form",font=('arial',20,'bold'),bg='white',fg='black')
        lbl_wel.pack()
    ...
    def deposit():
        ...
        lbl_wel=Label(ifrm,text="Deposit Form",font=('arial',20,'bold'),bg='white',fg='black')
        lbl_wel.pack()
    ...
    def transfer():
        ...
        lbl_wel=Label(ifrm,text="Transfer Details",font=('arial',20,'bold'),bg='white',fg='black')
        lbl_wel.pack()
